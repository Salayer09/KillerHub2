...
SheriffTab:CreateSlider("HorizontalPredMaxSlider", "Predicción Horizontal MÁXIMA", 0, 300, math_floor(SheriffConfig.HorizontalPredMax * 1000), function(valor)
    SheriffConfig.HorizontalPredMax = valor / 1000 
    saveConfig() 
end)

SheriffTab:CreateSlider("VerticalPredMinSlider", "Predicción Vertical MÍNIMA", 0, 90, math_floor(SheriffConfig.VerticalPredMin * 1000), function(valor)
    SheriffConfig.VerticalPredMin = valor / 1000
    saveConfig() 
end)

SheriffTab:CreateSlider("VerticalPredMaxSlider", "Predicción Vertical MÁXIMA", 0, 120, math_floor(SheriffConfig.VerticalPredMax * 1000), function(valor)
    SheriffConfig.VerticalPredMax = valor / 1000
    saveConfig() 
end)

SheriffTab:CreateSlider("CloseRangeZoneSlider", "Zona Muerta Quemarropa (Studs)", 0, 20, SheriffConfig.CloseRangeZone, function(valor)
...
SheriffTab:CreateSlider("TracerSmoothSlider", "Estabilizador Anti-Temblor (1 = Instantáneo)", 1, 100, 40, function(valor)
    if valor == 1 then
...
SheriffTab:CreateSlider("LeadTimeSlider", "Anticipación de la Mano (Lead Time)", 0, 100, math_floor(SheriffConfig.LeadTimePred * 100), function(valor)
...
SheriffTab:CreateSlider("VoidBtnSize", "Tamaño del Botón Sheriff", 50, 200, SheriffConfig.ButtonSize, function(valor)
